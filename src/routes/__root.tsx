...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "ارفع صورتك، اختر جوّك، واحصل على حكاية فريدة بملامحك. PDF فوري أو نسخة مطبوعة." },
    ...
    links: [
      ...
      { rel: "icon", href: "/icon.svg", sizes: "192x192", type: "image/svg+xml" },
      { rel: "icon", href: "/icon.svg", sizes: "512x512", type: "image/svg+xml" },
