...
const PRESETS = [
  { name: "محرم الحرام", color: "oklch(0.45 0.06 270)", banner_ar: "أيام محرم — مواعظ من كربلاء" },
  { name: "صفر", color: "oklch(0.50 0.07 60)", banner_ar: "شهر صفر — احفظ نفسك بالذكر" },
  { name: "ربيع الأول — المولد النبوي", color: "oklch(0.70 0.13 145)", banner_ar: "ذكرى المولد النبوي الشريف" },
  { name: "رمضان", color: "oklch(0.62 0.13 195)", banner_ar: "رمضان كريم — قصص الإيمان للأطفال" },
];
